...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/ILiekCarot/NewVape2/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/ILiekCarot/NewVape2/refs/heads/main/NewMainScript.lua)
3. Ensuring no external script is conflicting with vape.

## Developers & Credits
[ILiekCarot](https://github.com/ILiekCarot) - Lead Maintainer of NewVape2 - nomnomcarot on Discord
<br/>
[7GrandDad](https://github.com/7GrandDadPGN) - Developer of the original project - vaperoblox on Discord
<br/>
